...
# server-side re-exports (scripts/reexport.py) land here for download;
# an index.html generated by the script gives a link list
_EXPORT_FILES = os.path.join(EXPORTS_DIR, "files")
os.makedirs(_EXPORT_FILES, exist_ok=True)
app.mount("/exports_files", StaticFiles(directory=_EXPORT_FILES, html=True),
          name="exports_files")
